 ...
 *
 * @DataParser(
 *   id = "greenhouse_offices_json_parser",
 *   title = @Translation("Greenhouse Offices Json Parser")
 * )
 */
class GreenhouseOfficesJsonParser extends Json implements GhJobsInterface {
